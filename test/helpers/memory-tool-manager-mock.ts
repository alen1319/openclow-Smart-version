...
const stubManager = {
  search: vi.fn(async (query?: string, opts?: Parameters<SearchImpl>[1]) => await searchImpl(query, opts)),
...
export function getMemorySearchCalls() {
  return stubManager.search.mock.calls;
}
