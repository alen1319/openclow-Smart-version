...
import {
  ...
  resolveTelegramConversationLineage,
} from "./conversation-route.js";
import { resolveTelegramAuthorizationActor } from "./exec-approvals.js";
...
export async function buildTelegramInboundContextPayload(params: {
  ...
  const conversationLineage = resolveTelegramConversationLineage({
    cfg,
    route,
    chatId,
    isGroup,
  ...
  const authorizationActor = resolveTelegramAuthorizationActor({
    accountId: route.accountId,
    senderId: resolveTelegramAuthorizationSenderId({
      chatId,
      isGroup,
      senderId,
    }),
  ...
  const ctxPayload = sessionRuntime.finalizeInboundContext({
    ...
    To: `telegram:${chatId}`,
    SessionKey: route.sessionKey,
    ParentSessionKey: conversationLineage.parentSessionKey,
    MemoryRootSessionKey: conversationLineage.memoryRootSessionKey,
    MemorySessionKeyCandidates: conversationLineage.memorySessionKeyCandidates,
    AccountId: route.accountId,
    ChatType: isGroup ? "group" : "direct",
    ...
    AuthorizationSubjectKey: authorizationActor.authorizationSubjectKey,
