  ...
  bot.on("callback_query", async (ctx) => {
    ...
    try {
      ...
      if (approvalCallback) {
        ...
        const approvalSenderId = resolveTelegramAuthorizationSenderId({
          chatId,
          isGroup,
          senderId,
          strictDirectSender: true,
        });
        const approvalActor = resolveTelegramAuthorizationActor({
          accountId,
          senderId: approvalSenderId,
        });
        ...
        try {
          ...
          await (telegramDeps.resolveExecApproval ?? resolveTelegramExecApproval)({
            ...
            accountId,
            senderId: approvalSenderId,
            authorizationSubjectKey: approvalActor.authorizationSubjectKey,
            approverIdentityKey: approvalActor.approverIdentityKey,
