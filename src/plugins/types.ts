...
import type { AnyAgentTool, ToolAuthorizationLevel } from "../agents/tools/common.js";
...
export type OpenClawPluginToolContext = {
  ...
  /** Stable sender-scoped authorization subject key for audit/correlation. */
  authorizationSubjectKey?: string;
  /** Stable approver identity key for approval-chain audit/correlation. */
  approverIdentityKey?: string;
  /** Whether the trusted sender is an owner. */
  senderIsOwner?: boolean;
  /** Whether the trusted sender is an approver for approval-scoped capabilities. */
  senderIsApprover?: boolean;
  /** Effective sender authorization level from command/channel auth resolution. */
