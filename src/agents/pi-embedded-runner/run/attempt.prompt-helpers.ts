...
export function buildAfterTurnRuntimeContext(params: {
  ...
  return buildEmbeddedCompactionRuntimeContext({
    ...
    senderIsApprover: params.attempt.senderIsApprover,
    senderAuthorizationLevel: params.attempt.senderAuthorizationLevel,
    isAuthorizedSender: params.attempt.isAuthorizedSender,
