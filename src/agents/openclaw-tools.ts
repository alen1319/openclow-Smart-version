...
export function createOpenClawTools(
  options?: {
    ...
    /** Whether the requesting sender is an approver. */
    senderIsApprover?: boolean;
    /** Effective sender authorization level for shared tool-policy gating. */
    senderAuthorizationLevel?: ToolAuthorizationLevel;
    /** Whether sender passed channel/command authorization checks. */
  ...
  const pluginTools = resolvePluginTools({
    context: {
      ...
      deliveryContext,
      requesterSenderId: options?.requesterSenderId ?? undefined,
      authorizationSubjectKey: options?.authorizationSubjectKey?.trim() || undefined,
      approverIdentityKey: options?.approverIdentityKey?.trim() || undefined,
      senderIsOwner: options?.senderIsOwner ?? undefined,
      senderIsApprover: options?.senderIsApprover ?? undefined,
