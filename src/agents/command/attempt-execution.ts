...
export function runAgentAttempt(params: {
  ...
  return runEmbeddedPiAgent({
    ...
    senderE164: params.opts.senderE164,
    currentChannelId: params.runContext.currentChannelId,
    currentThreadTs: params.runContext.currentThreadTs,
    replyToMode: params.runContext.replyToMode,
    hasRepliedRef: params.runContext.hasRepliedRef,
    senderIsOwner: params.opts.senderIsOwner,
    senderIsApprover: params.opts.senderIsApprover,
    senderAuthorizationLevel: params.opts.senderAuthorizationLevel,
    isAuthorizedSender: params.opts.isAuthorizedSender,
    authorizationSubjectKey: params.opts.authorizationSubjectKey,
    approverIdentityKey: params.opts.approverIdentityKey,
    sessionFile: params.sessionFile,
    workspaceDir: params.workspaceDir,
    config: params.cfg,
