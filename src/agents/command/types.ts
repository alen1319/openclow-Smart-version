...
export type AgentCommandOpts = {
  ...
  /** Trusted sender identity from the ingress boundary. */
  senderId?: string;
  senderName?: string;
  senderUsername?: string;
  senderE164?: string;
  /** Whether this caller is an approver for approval-scoped capabilities. */
  senderIsApprover?: boolean;
  /** Effective sender authorization level from the ingress boundary. */
  senderAuthorizationLevel?: ToolAuthorizationLevel;
  /** Whether this caller passed boundary authorization checks. */
  isAuthorizedSender?: boolean;
  /** Stable sender-scoped authorization subject for audit trails. */
  authorizationSubjectKey?: string;
  /** Stable approver identity for approval-chain audit trails. */
