...
import { APPROVALS_SCOPE, authorizeOperatorScopesForMethod } from "./method-scopes.js";
...
export async function handleToolsInvokeHttpRequest(
  ...
  const authorization = resolveToolAuthorizationContext({
    senderIsOwner,
    senderIsApprover,
    isAuthorizedSender: scopeAuth.allowed,
  });
  ...
  const gatewayFiltered = applyToolAuthorizationPolicy(tools, authorization);
