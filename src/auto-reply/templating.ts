...
export type MsgContext = {
  ...
  /** Stable conversation-root session used for memory inheritance. */
  MemoryRootSessionKey?: string;
  /** Ordered memory inheritance candidates: current first, then parent/root fallbacks. */
  MemorySessionKeyCandidates?: string[];
  MessageSid?: string;
  ...
  /** Canonical authorization identity resolved at channel ingress. */
  AuthorizationSubject?: AuthorizationSubject;
  /**
   * @deprecated Use AuthorizationSubject.
   * Backward-compatible field retained for staged migrations.
   */
