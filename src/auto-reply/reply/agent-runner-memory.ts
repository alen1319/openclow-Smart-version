...
export async function runPreflightCompactionIfNeeded(params: {
  ...
  const result = await compactEmbeddedPiSession({
    ...
    senderIsApprover: params.followupRun.run.senderIsApprover,
    senderAuthorizationLevel: params.followupRun.run.senderAuthorizationLevel,
    isAuthorizedSender: params.followupRun.run.isAuthorizedSender,
    authorizationSubjectKey: params.followupRun.run.authorizationSubjectKey,
    approverIdentityKey: params.followupRun.run.approverIdentityKey,
