...
describe("handleCommands /allowlist", () => {
  ...
  it("blocks allowlist writes from authorized non-owner senders before channel resolution", async () => {
    const cfg = {
      commands: {
        text: true,
        config: true,
    ...
    const params = buildPolicyParams("/allowlist add dm --channel unknown attacker-id", cfg, {
      Provider: "telegram",
      Surface: "telegram",
      SenderId: "telegram-attacker",
      From: "telegram-attacker",
