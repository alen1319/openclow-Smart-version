...
import { applyToolAuthorizationPolicy } from "../../agents/tool-policy.js";
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const tools = createOpenClawTools({
        ...
        requesterSenderId: command.senderId,
        authorizationSubjectKey: command.authorizationSubjectKey,
        approverIdentityKey: command.approverIdentityKey,
        senderIsOwner: command.senderIsOwner,
        senderIsApprover: command.senderIsApprover,
        senderAuthorizationLevel: command.senderAuthorizationLevel,
      ...
      const authorizedTools = applyToolAuthorizationPolicy(tools, {
        level: command.senderAuthorizationLevel,
        senderIsOwner: command.senderIsOwner,
        senderIsApprover: command.senderIsApprover,
        isAuthorizedSender: command.isAuthorizedSender,
      });
