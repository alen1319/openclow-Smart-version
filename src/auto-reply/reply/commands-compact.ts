...
export const handleCompactCommand: CommandHandler = async (params) => {
  ...
  const result = await compactEmbeddedPiSession({
    ...
    senderIsApprover: params.command.senderIsApprover,
    senderAuthorizationLevel: params.command.senderAuthorizationLevel,
    isAuthorizedSender: params.command.isAuthorizedSender,
    authorizationSubjectKey: params.command.authorizationSubjectKey,
    approverIdentityKey: params.command.approverIdentityKey,
