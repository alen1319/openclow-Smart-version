          ...
          run: async (provider, model, runOptions) => {
            ...
            try {
              const result = await runEmbeddedPiAgent({
                ...
                senderIsApprover: queued.run.senderIsApprover,
                senderAuthorizationLevel: queued.run.senderAuthorizationLevel,
                isAuthorizedSender: queued.run.isAuthorizedSender,
