...
export function buildCommandContext(params: {
  ...
  return {
    ...
    senderIsApprover: auth.senderIsApprover,
    senderAuthorizationLevel: auth.senderAuthorizationLevel,
    isAuthorizedSender: auth.isAuthorizedSender,
    authorizationSubjectKey: auth.authorizationSubjectKey,
    approverIdentityKey: auth.approverIdentityKey,
