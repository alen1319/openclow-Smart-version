...
openclaw setup --workspace-template claude-code
...
- `--workspace-template <name>`: workspace template preset (`default` or `claude-code`)
...
- `--workspace-template claude-code` bootstraps a coding-focused workspace with Claude Code style instructions and notes.
