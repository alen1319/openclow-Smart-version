...
openclaw onboard --workspace-template claude-code
...
Useful workspace presets:

- `--workspace-template claude-code`: create a coding-focused workspace with Claude Code style `AGENTS.md`, `SOUL.md`, `TOOLS.md`, and `BOOTSTRAP.md`.
